...
(defclass  transport ()
  ((type :initarg :transport-type
         ...
         :allocation :instance
         :documentation "A transport-type describes the type of transport
   ...
   (specific-address :initarg :transport-address
         ...
         :allocation  :instance
         :documentation "A transport address specific to a given
         transport-type")
  ...
  (:documentation "A transport is a particular data delivery service supported
  by a given msg-transport-service."))

(defclass  transport-description (transport)
  ()
  (:documentation "A transport-description is a self describing structure
  containing a transport-type, a transport-specific-address and zero or more
  transport-specific-properties."))

;; abstract class (concrete class MAY to inherit)
(defclass transport-specific-property()
  ()
  (:documentation "A transport-specific-property is a property associated with a
  transport-type."))
